...
(define (domain gym-palnner)
    ...
    (:types
        ...
        Lunges PushPress PushUps PullUps Back_TBarRow Back_30DegreeLatPulldown - machineWithoutSpotter
        Squat Deadlift BenchPress Arms_SeatedInclineDumbbellCurl - machineWithSpotter
    )
