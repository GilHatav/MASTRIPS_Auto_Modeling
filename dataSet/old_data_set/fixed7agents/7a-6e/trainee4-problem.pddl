...
(define (problem gym-training) (:domain gym-palnner)
    ...
    (:init
        ...
        (want pers4 mach_Lunges)
		(want pers4 mach_PushPress)
		(want pers4 mach_PushUps)
		(want pers4 mach_PullUps)
		(want pers4 mach_Deadlift)
		(want pers4 mach_Squat)
		(want pers4 mach_Arms_SeatedInclineDumbbellCurl)
    )
    (:goal
        (and
            (done pers4 mach_Lunges)
			(done pers4 mach_PushPress)
			(done pers4 mach_PushUps)
			(done pers4 mach_PullUps)
			(done pers4 mach_Deadlift)
			(done pers4 mach_Squat)
			(done pers4 mach_Arms_SeatedInclineDumbbellCurl)
        )
    )
)
