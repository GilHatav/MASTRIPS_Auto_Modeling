...
(define (problem gym-training) (:domain gym-palnner)
    ...
    (:init
        ...
        (want pers9 mach_Back_30DegreeLatPulldown)
		(want pers9 mach_PushUps)
		(want pers9 mach_PullUps)
		(want pers9 mach_PushPress)
		(want pers9 mach_Arms_SeatedInclineDumbbellCurl)
		(want pers9 mach_BenchPress)
		(want pers9 mach_Deadlift)
    )
    (:goal
        (and
            (done pers9 mach_Back_30DegreeLatPulldown)
			(done pers9 mach_PushUps)
			(done pers9 mach_PullUps)
			(done pers9 mach_PushPress)
			(done pers9 mach_Arms_SeatedInclineDumbbellCurl)
			(done pers9 mach_BenchPress)
			(done pers9 mach_Deadlift)
        )
    )
)
