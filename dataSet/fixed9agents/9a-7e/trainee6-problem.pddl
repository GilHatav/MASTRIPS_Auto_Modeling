...
(define (problem gym-training) (:domain gym-palnner)
    ...
    (:init
        ...
        (want pers6 mach_PushPress)
		(want pers6 mach_PullUps)
		(want pers6 mach_PushUps)
		(want pers6 mach_Back_30DegreeLatPulldown)
		(want pers6 mach_BenchPress)
		(want pers6 mach_Squat)
		(want pers6 mach_Arms_SeatedInclineDumbbellCurl)
    )
    (:goal
        (and
            (done pers6 mach_PushPress)
			(done pers6 mach_PullUps)
			(done pers6 mach_PushUps)
			(done pers6 mach_Back_30DegreeLatPulldown)
			(done pers6 mach_BenchPress)
			(done pers6 mach_Squat)
			(done pers6 mach_Arms_SeatedInclineDumbbellCurl)
        )
    )
)
