...
(define (problem gym-training) (:domain gym-palnner)
    ...
    (:init
        ...
        (want pers7 mach_Lunges)
		(want pers7 mach_Back_TBarRow)
		(want pers7 mach_PullUps)
		(want pers7 mach_Back_30DegreeLatPulldown)
		(want pers7 mach_BenchPress)
		(want pers7 mach_Deadlift)
		(want pers7 mach_Arms_SeatedInclineDumbbellCurl)
    )
    (:goal
        (and
            (done pers7 mach_Lunges)
			(done pers7 mach_Back_TBarRow)
			(done pers7 mach_PullUps)
			(done pers7 mach_Back_30DegreeLatPulldown)
			(done pers7 mach_BenchPress)
			(done pers7 mach_Deadlift)
			(done pers7 mach_Arms_SeatedInclineDumbbellCurl)
        )
    )
)
